...
namespace Recam.DataAccess.Migrations
{
    ...
    [Migration("20251213121443_Unique_Hero_Media_Asset_Constraint")]
    partial class Unique_Hero_Media_Asset_Constraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recam.Models.Entities.MediaAsset", b =>
                {
                    ...
                    b.HasIndex("ListingCaseId", "IsHero")
                        .IsUnique()
                        .HasFilter("[IsHero] = 1");
            ...
            modelBuilder.Entity("Recam.Models.Entities.UserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Recam.Models.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Recam.Models.Entities.UserRole", b =>
                {
                    b.HasOne("Recam.Models.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
